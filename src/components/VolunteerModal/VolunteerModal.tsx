  ...
  <span className={styles.requiredNote}>
    Зірочка (*) вказує, що запитання обов'язкове.
        ...
        >
          ...
          {/* 10 */}
          <label className={styles.label}>
            10. Чи є у Вас автотранспорт та права? *
            <input
              ref={transportRef}
              name="transport"
          ...
          {/* 11 */}
          <label className={styles.label}>
            11. Досвід волонтерської діяльності *
            <input
              ref={experienceRef}
              name="experience"
          ...
          {/* 13 */}
          <label className={styles.label}>
            13. Досвід проведення семінарів/тренінгів *
            <input
              ref={seminarRef}
              ...
              {[
                ...
                <label key={label}>
                  ...
                  {label}
                      ...
                      </label> {/* ← ось цього закриття не вистачало */}
                  
                  {/* 15 */}
<label className={styles.label}>
  15. Скільки годин на місяць Ви можете приділяти волонтерській діяльності? *
  <input
    ref={monthlyHoursRef}
    name="monthlyHours"
...
{/* 16 */}
<label className={styles.label}>
  16. Які дні найбільш зручні для Вашої волонтерської діяльності? *
  <input
...
{/* 17 */}
<label className={styles.label}>
  17. Чи готові Ви дотримуватися Основоположних принципів Міжнародного Руху? *
  <div className={styles.checkboxGroup}>
...
{/* 19 */}
<label className={styles.label}>
  19. Згода на обробку персональних даних *
